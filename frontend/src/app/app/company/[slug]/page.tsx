...
export default function ProjectPage({
  ...
  return (
    <div className="space-y-8">
      ...
      <DashboardTwoColumn>
      <DashboardSection title="Most common issues">
          <DashboardDataTable
            columns={[
              {
                key: "issue",
        ...
        <DashboardSection title="Compared with company average">
          <div className="space-y-4">
            {data.versusCompanyAverage.map((item) => (
              <div
                key={item.label}
                className="flex items-center justify-between gap-4 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3.5 dark:border-white/10 dark:bg-slate-950/55"
              >
      ...
      <DashboardSection title="Recent issues">
        <DashboardDataTable
          columns={[
            {
              key: "issue",
